...
function readStorage() {
	...
	if ( true === localStorage['isSignedIn'] || 'true' === localStorage['isSignedIn'] ) {
...
function addDevice( device ) {
	...
	if( 1 === document.getElementById( 'sctDeviceList' ).options.length ) {
...
function clearDevices() {
	...
	for ( let i = deviceListLength - 1; 0 <= i; i-- ) {

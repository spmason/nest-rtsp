...
function setSessionDescriptionError( error ) {
	...
	if ( 'function' === typeof emitFatality ) {
		emitFatality( `Failed to create session description: ${error.toString()}.` )
	}
}
...
function handleLocalMediaStreamError( error ) {
	...
	if ( 'function' === typeof emitFatality ) {
		emitFatality( `navigator.getUserMedia error: ${error.toString()}.` )
	}
}
...
const handleReceiveMessage = event => {
	...
	if ( 'function' === typeof emitReady ) {
		emitReady( event.data )
	}
}
